  ...
  <body onload="submitPayuForm()" style="background-image: url(b2.png); background-size: 60%; background-repeat: no-repeat; background-position:left;">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <center> <table style="border:dotted; border-style:dashed; border-spacing:10px; border-color: black; text-align: center;">
        <tr>
          <td><b style="text-align: center;">Please fill all the fields:</b></td>
        </tr>
        <tr>
          <td>Amount: </td>
      ...
      <dl style="text-align: center; padding-top: 2%; padding-left: 3%; color:olive; font-size: 30px;">
      <dt><i>"The smallest act of kindness is worth more than the grandest intensiton".</dt>  
      <dd>                    -Oscar Wilde</dd></i>
      </dl>
    </form>
  </body>
